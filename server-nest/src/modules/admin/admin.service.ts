...
const NUM_KEYS: Record<string, [number, number]> = {
  ...
  upload_limit_normal_image_mb: [1, 200], upload_limit_normal_video_mb: [1, 200], upload_limit_normal_audio_mb: [1, 200], upload_limit_normal_document_mb: [1, 200],
  upload_limit_vip_image_mb: [1, 200], upload_limit_vip_video_mb: [1, 200], upload_limit_vip_audio_mb: [1, 200], upload_limit_vip_document_mb: [1, 200],
  upload_limit_verified_image_mb: [1, 200], upload_limit_verified_video_mb: [1, 200], upload_limit_verified_audio_mb: [1, 200], upload_limit_verified_document_mb: [1, 200],
